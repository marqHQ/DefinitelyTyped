...
declare namespace goog.positioning {
     ...
     * @enum {number}
     */
    enum CornerBit { BOTTOM, CENTER, RIGHT, FLIP_RTL }
    ...
    function getPositionAtCoordinate(
        absolutePos: goog.math.Coordinate,
        elementSize: goog.math.Size,
        elementCorner: goog.positioning.Corner,
        opt_margin?: goog.math.Box,
        opt_viewport?: goog.math.Box,
        opt_overflow?: number|null
...
declare namespace goog.positioning.OverflowStatus {
    /**
     ...
     * @type {number}
     */
    let FAILED_HORIZONTAL: number;

    /**
     * Shorthand to check if vertical positioning failed.
     * @type {number}
     */
    let FAILED_VERTICAL: number;
}

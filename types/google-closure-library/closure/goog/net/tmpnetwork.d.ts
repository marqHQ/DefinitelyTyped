...
declare namespace goog.net.tmpnetwork {
     ...
     */
    function testGoogleCom(callback: Function, opt_imageUri?: goog.Uri|null, opt_timeout?: number): void;
    ...
    function testLoadImageWithRetries(
        url: string, timeout: number, callback: Function, retries: number, opt_pauseBetweenRetriesMS?: number
    ): void;

...
declare namespace goog.functions {
     ...
     */
    let FALSE: any /*missing*/;

    /**
     * Always returns true.
     * @type {function(...): boolean}
     */
    let TRUE: any /*missing*/;

    /**
     * Always returns NULL.
     * @type {function(...): null}
     */
    let NULL: any /*missing*/;
     ...
     */
    function equalTo(value: any, opt_useLooseComparison?: boolean): (_0: any) => boolean;
     ...
     * opposite.
     */
    function not(f: Function): (...args: any[]) => boolean;
     ...
     * @template T
     */
    function create(Object: any /*missing*/, var_args: any /* jsdoc error */): void;
     ...
     * @template SCOPE
     */
    function debounce<SCOPE>(f: (this: SCOPE, _0: any[]) => void, interval: number, opt_scope?: SCOPE): (_0: any[]) =>
        undefined;
     ...
     * @template SCOPE
     */
    function throttle<SCOPE>(f: (this: SCOPE, _0: any[]) => void, interval: number, opt_scope?: SCOPE): (_0: any[]) =>
        undefined;
     ...
     * @template SCOPE
     */
    function rateLimit<SCOPE>(f: (this: SCOPE, _0: any[]) => void, interval: number, opt_scope?: SCOPE): (_0: any[]) =>
        undefined;
}

...
declare namespace goog.proto2 {
    ...
    abstract class __Serializer {
         ...
         * @protected
         */
        protected getSerializedValue(field: goog.proto2.FieldDescriptor, value: any): any;
         ...
         * @protected
         */
        protected getDeserializedValue(field: goog.proto2.FieldDescriptor, value: any): any;
    }
}

declare namespace goog.proto2.Serializer {
    /** @const {!RegExp} */
    const INTEGER_REGEX: any /*missing*/;
}

...
declare namespace goog.style {
     ...
     */
    function getContainerOffsetToScrollInto(element: Element, opt_container?: Element, opt_center?: boolean):
    ...
    function translateRectForAnotherFrame(
        rect: goog.math.Rect, origBase: goog.dom.DomHelper, newBase: goog.dom.DomHelper
    ): void;
     ...
     */
    function getRelativePosition(a: Element|Event|goog.events.Event, b: Element|Event|goog.events.Event):
        goog.math.Coordinate;
     ...
     */
    function installSafeStyleSheet(safeStyleSheet: goog.html.SafeStyleSheet, opt_node?: Node|null): HTMLStyleElement|
        StyleSheet;

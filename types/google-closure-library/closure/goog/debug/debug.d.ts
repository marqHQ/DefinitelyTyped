...
declare namespace goog.debug {
     ...
     *    on Object.
     */
    function catchErrors(logFunc: (_0: Object) => void, opt_cancel?: boolean, opt_target?: Object): void;
    ...
    function normalizeErrorObject(err: any): {
        message: any|undefined; name: any | undefined; lineNumber: any | undefined; fileName: any | undefined;
        stack: any | undefined
    };
     ...
     *     it is converted to an Error which is enhanced and returned.
     */
    function enhanceErrorWithContext(err: any, opt_context?: {[key: string]: string}): Error;

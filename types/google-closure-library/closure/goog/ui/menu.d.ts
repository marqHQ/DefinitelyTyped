...
declare namespace goog.ui {
     ...
     */
    class Menu extends __Menu {}
    abstract class __Menu extends goog.ui.__Container {
        /**
         ...
         * @private
         */
        private allowHighlightDisabled_: boolean;
         ...
         */
        getItemAt(n: number): goog.ui.MenuHeader|goog.ui.MenuItem|goog.ui.MenuSeparator|null;
         ...
         */
        getPosition(): goog.math.Coordinate|null;
         ...
         * @protected
         */
        protected decorateContent(element: Element): void;
    }
}

declare namespace goog.ui.Menu {
    /**

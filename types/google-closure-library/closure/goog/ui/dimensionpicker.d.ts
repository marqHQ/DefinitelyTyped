...
declare namespace goog.ui {
    ...
    abstract class __DimensionPicker extends goog.ui.__Control {
        /**
         ...
         * @private
         */
        private highlightedRows_: number;
         ...
         * @private
         */
        private highlightedColumns_: number;

        /**
         * Resets the highlighted size when the picker is shown.
         * @private
         */
        private handleShow_(): void;
         ...
         * @protected
         */
        protected handleMouseMove(e: goog.events.BrowserEvent): void;
         ...
         * @protected
         */
        protected handleWindowResize(e: goog.events.Event): void;

...
declare namespace goog.ui {
    ...
    abstract class __ControlRenderer {
        /**
         */
        constructor();
         ...
         */
        setAriaRole(element: Element, opt_preferredRole?: goog.a11y.aria.Role|null): void;
         ...
         * @protected
         */
        protected updateAriaState(element: Element, state: goog.ui.Component.State, enable: boolean): void;
         ...
         * @protected
         */
        protected getClassNames(control: goog.ui.Control): string[];
         ...
         * @private
         */
        private getAppliedCombinedClassNames_(classes: IArrayLike<string>, opt_includedClass?: string|null): string[];
         ...
         * @protected
         */
        protected getClassForState(state: goog.ui.Component.State): string|undefined;
         ...
         * @protected
         */
        protected getStateFromClass(className: string): goog.ui.Component.State;

        /**
         * Creates the lookup table of states to classes, used during state changes.
         * @private
         */
        private createClassByStateMap_(): void;
         ...
         * @private
         */
        private stateByClass_: Object;
    }
}

declare namespace goog.ui.ControlRenderer {
    /**

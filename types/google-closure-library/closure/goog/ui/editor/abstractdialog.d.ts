...
declare namespace goog.ui.editor {
    ...
    abstract class __AbstractDialog extends goog.events.__EventTarget {
        /**
        ...
        private dialogInternal_: any /*missing*/;
         ...
         * @protected
         */
        protected dom: goog.dom.DomHelper;
         ...
         * @protected
         */
        protected createDialogControl(): goog.ui.Dialog;
         ...
         * @protected
         */
        protected getOkButtonElement(): Element;
         ...
         * @protected
         */
        protected getCancelButtonElement(): Element;
         ...
         * @protected
         */
        protected getButtonElement(buttonId: string): Element;
         ...
         * @protected
         */
        protected createOkEvent(e: goog.events.Event): goog.events.Event;
         ...
         * @protected
         */
        protected handleOk(e: goog.ui.Dialog.Event): boolean;
...
declare namespace goog.ui.editor.AbstractDialog {
    ...
    abstract class __Builder {
         ...
         * @return {!goog.ui.editor.AbstractDialog.Builder} This.
         */
        addButton(label: string, handler: (_0: goog.ui.Dialog.EventType) => any, opt_buttonId?: string):
         ...
         * @private
         */
        private editorDialog_: goog.ui.editor.AbstractDialog;
         ...
         * @private
         */
        private wrappedDialog_: goog.ui.Dialog;
         ...
         * @private
         */
        private buttonSet_: goog.ui.Dialog.ButtonSet;
         ...
         * @private
         */
        private buttonHandlers_: Object;
    }

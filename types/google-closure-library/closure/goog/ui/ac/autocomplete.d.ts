...
declare namespace goog.ui.ac {
    ...
    abstract class __AutoComplete extends goog.events.__EventTarget {
        /**
         ...
         * @suppress {underscore|visibility}
         */
        protected selectionHandler_: Object;
         ...
         * @suppress {underscore|visibility}
         */
        protected renderer_: goog.events.EventTarget;
         ...
         * @private
         */
        private inputToAnchorMap_: {[key: string]: Element};
         ...
         * @private
         */
        private allowFreeSelect_: boolean;
         ...
         * @private
         */
        private triggerSuggestionsOnUpdate_: boolean;
         ...
         * @protected
         */
        protected setRenderer(renderer: goog.events.EventTarget): void;
         ...
         * @private
         */
        private immediatelyCancelDelayedDismiss_(): boolean;
         ...
         * @private
         */
        private matchListener_(matchedToken: string, rows: any[], opt_options?: boolean|goog.ui.ac.RenderOptions): void;
         ...
         * @private
         */
        private getIdOfIndex_(index: number): number;
...
declare namespace goog.ui.ac.AutoComplete {
    /**

...
declare namespace goog.ui.registry {
     ...
     */
    function getDefaultRenderer(componentCtor: Function): goog.ui.ControlRenderer|null;
     ...
     */
    function getDecoratorByClassName(className: string): goog.ui.Component|null;
     ...
     *     none).
     */
    function getDecorator(element: Element): goog.ui.Component|null;

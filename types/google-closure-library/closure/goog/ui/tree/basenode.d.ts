...
declare namespace goog.ui.tree {
    ...
    abstract class __BaseNode extends goog.ui.__Component {
        /**
        ...
        /** @private {string} */
        private iconClass_: any /*missing*/;

        /** @private {string} */
        private expandedIconClass_: any /*missing*/;

        /** @protected {goog.ui.tree.TreeControl} */
        protected tree: any /*missing*/;

        /** @private {goog.ui.tree.BaseNode} */
        private previousSibling_: any /*missing*/;

        /** @private {goog.ui.tree.BaseNode} */
        private nextSibling_: any /*missing*/;

        /** @private {goog.ui.tree.BaseNode} */
        private firstChild_: any /*missing*/;

        /** @private {goog.ui.tree.BaseNode} */
        private lastChild_: any /*missing*/;

        /**
         * Whether the tree item is selected.
         * @private {boolean}
         */
        private selected_: any /*missing*/;

        /**
         * Whether the tree node is expanded.
         * @private {boolean}
         */
        private expanded_: any /*missing*/;

        /**
         * Tooltip for the tree item
         * @private {?string}
         */
        private toolTip_: any /*missing*/;

        /**
         * HTML that can appear after the label (so not inside the anchor).
         * @private {!goog.html.SafeHtml}
         */
        private afterLabelHtml_: any /*missing*/;

        /**
         * Whether to allow user to collapse this node.
         * @private {boolean}
         */
        private isUserCollapsible_: any /*missing*/;
         ...
         * @private
         */
        private onTimeoutSelect_(): void;

        /**
         * Returns the tree.
         * @return {?goog.ui.tree.TreeControl}
         */
        getTree(): goog.ui.tree.TreeControl|null;
         ...
         * @private
         */
        private setDepth_(depth: number): void;
         ...
         * @protected
         */
        protected toSafeHtml(): goog.html.SafeHtml;

        /**
         * @return {number} The pixel indent of the row.
         * @private
         */
        private getPixelIndent_(): number;

        /**
         * @return {!goog.html.SafeHtml} The html for the row.
         * @protected
         */
        protected getRowSafeHtml(): goog.html.SafeHtml;
         ...
         * @protected
         */
        protected getLabelSafeHtml(): goog.html.SafeHtml;
         ...
         * @protected
         */
        protected getIconSafeHtml(): goog.html.SafeHtml;

        /**
         * Gets the calculated icon class.
         * @protected
         */
        protected getCalculatedIconClass: any /*missing*/;

        /**
         * @return {!goog.html.SafeHtml} The source for the icon.
         * @protected
         */
        protected getExpandIconSafeHtml(): goog.html.SafeHtml;
         ...
         * @protected
         */
        protected getExpandIconElement(): Element;

        /**
         * @return {Element} The icon element.
         * @protected
         */
        protected getIconElement(): Element;
         ...
         * @protected
         */
        protected getChildrenElement(): Element;
         ...
         * @protected
         */
        protected onMouseDown(e: goog.events.BrowserEvent): void;
         ...
         */
        protected onClick_(e: goog.events.BrowserEvent): void;
         ...
         * @suppress {underscore|visibility}
         */
        protected onDoubleClick_(e: goog.events.BrowserEvent): void;
         ...
         * @protected
         */
        protected onKeyDown(e: goog.events.BrowserEvent): boolean;
...
declare namespace goog.ui.tree.BaseNode {
    /**

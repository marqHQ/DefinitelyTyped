...
/// <reference path="./emojipicker.d.ts"/>
...
declare module 'goog:goog.ui.emoji.PopupEmojiPicker' {
    import alias = goog.ui.emoji.PopupEmojiPicker;
...
declare namespace goog.ui.emoji {
    ...
    abstract class __PopupEmojiPicker extends goog.ui.__Component {
        /**
         ...
         * @private
         */
        private emojiPicker_: goog.ui.emoji.EmojiPicker;
         ...
         */
        addEmojiGroup(title: string|Element, emojiGroup: any[][]): void;
         ...
         * @private
         */
        private onEmojiPicked_(e: goog.events.Event): void;
    }
}

...
declare namespace goog.ui {
    ...
    abstract class __ContainerRenderer {
        /**
         ...
         */
        protected setStateFromClassName(container: goog.ui.Container, className: string, baseClass: string): void;
         ...
         *     (null if none).
         */
        getDecoratorForChild(element: Element): goog.ui.Control|null;
...
declare namespace goog.ui.ContainerRenderer {
    /**

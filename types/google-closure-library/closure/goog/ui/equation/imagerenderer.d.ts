...
declare namespace goog.ui.equation.ImageRenderer {
    /**
     * The longest equation which may be displayed, in characters.
     * @type {number}
     */
    let MAX_EQUATION_LENGTH: number;

    /**
     * Class to put on our equations IMG elements.
     * @type {string}
     */
    let EE_IMG_CLASS: string;
     ...
     * @type {string}
     */
    let EE_IMG_ATTR: string;

    /**
     * Vertical alignment for the equations IMG elements.
     * @type {string}
     */
    let EE_IMG_VERTICAL_ALIGN: string;
     ...
     * @type {string}
     */
    let NO_RESIZE_IMG_CLASS: string;

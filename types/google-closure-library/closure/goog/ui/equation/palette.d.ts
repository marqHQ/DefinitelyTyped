...
declare namespace goog.ui.equation {
    ...
    abstract class __Palette extends goog.ui.__Palette {
        /**
         ...
         */
        constructor(
            paletteManager: goog.ui.equation.PaletteManager,
    ...
    class PaletteEvent extends __PaletteEvent {}
    /** Fake class which should be extended to avoid inheriting static properties */
    abstract class __PaletteEvent extends goog.events.__Event {
        /**
    ...
    /** Fake class which should be extended to avoid inheriting static properties */
    abstract class __PaletteRenderer extends goog.ui.__PaletteRenderer {
        /**
...
declare namespace goog.ui.equation.Palette {
    /**
...
declare namespace goog.ui.equation.PaletteEvent {
    /**

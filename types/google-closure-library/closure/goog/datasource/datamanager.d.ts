...
declare namespace goog.ds {
    ...
    abstract class __DataManager extends goog.ds.__DataNode {
        /**
         */
        constructor();
         ...
         * @private
         */
        private listenForAlias_(dataPath: string, name: string): void;
         ...
         * @private
         */
        private removeListenersByFunction_(
            listenersByFunction: Object, indexed: boolean, fn: Function, opt_dataPath?: string, opt_id?: string
        ): void;
...
declare namespace goog.ds.DataManager {
    /**

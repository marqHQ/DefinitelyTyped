...
declare namespace goog.cssom {
     ...
     * @enum {number}
     */
    enum CssRuleType { STYLE, IMPORT, MEDIA, FONT_FACE, PAGE, NAMESPACE }
     ...
     */
    function getAllCssStyleRules(opt_styleSheet?: StyleSheet|StyleSheetList): CSSStyleRule[];
     ...
     */
    function getAllCssStyleSheets(opt_styleSheet?: StyleSheet|StyleSheetList, opt_includeDisabled?: boolean):
        StyleSheet[];
     ...
     */
    function replaceCssRule(cssRule: CSSRule, cssText: string, opt_parentStyleSheet?: StyleSheet, opt_index?: number):
        void;

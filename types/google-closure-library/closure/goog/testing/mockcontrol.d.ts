...
declare namespace goog.testing {
    ...
    abstract class __MockControl {
         ...
         * @private
         */
        private mocks_: goog.testing.MockInterface[];
         ...
         */
        createStrictMock(objectToMock: Object|Function, opt_mockStaticMethods?: boolean, opt_createProxy?: boolean):
         ...
         * @return {!goog.testing.MockInterface} The mocked method.
         */
        createConstructorMock(scope: Object, constructorName: string, opt_strictness?: number):

...
declare namespace goog.testing.dom {
     ...
     */
    function findTextNode(textOrRegexp: string|RegExp, root: Element): Node|null;
     ...
     */
    function assertRangeEquals(
        start: Node, startOffset: number, end: Node, endOffset: number, range: goog.dom.AbstractRange
    ): void;
}

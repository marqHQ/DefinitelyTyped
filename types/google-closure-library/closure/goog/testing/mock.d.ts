...
declare namespace goog.testing {
    ...
    abstract class __MockExpectation {
        /**
    ...
    abstract class __Mock implements goog.testing.MockInterface {
        /**
         ...
         * @protected
         */
        protected $pendingExpectation: goog.testing.MockExpectation;
         ...
         * @private
         */
        private $threwException_: Object;
         ...
         * @private
         */
        private $initializeFunctions_(objectToMock: Object): void;
         ...
         * @protected
         */
        protected $recordCall(name: string, args: any[]): any;
         ...
         * @protected
         */
        protected $recordAndThrow(ex: Object): void;
         ...
         */
        $verifyCall(expectation: goog.testing.MockExpectation, name: string, args: any[]|null): boolean;
         ...
         *     if any.
         */
        $throwCallException(name: string, args: any[]|null, opt_expectation?: goog.testing.MockExpectation): void;
...
declare namespace goog.testing.Mock {
    /**

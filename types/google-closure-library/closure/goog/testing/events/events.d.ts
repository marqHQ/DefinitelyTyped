...
declare namespace goog.testing.events {
    ...
    abstract class __Event extends goog.testing._events.GlobalEvent {
        /**
     ...
     *     was called on any of the events, true otherwise.
     */
    function fireDoubleClickSequence(
        target: EventTarget, opt_coords?: goog.math.Coordinate, opt_eventProperties?: Object
    ): boolean;
     ...
     *     was called on any of the events, true otherwise.
     */
    function fireKeySequence(target: EventTarget, keyOrKeyCode: string|number, opt_eventProperties?: Object): boolean;
     ...
     *     was called on any of the events, true otherwise.
     */
    function fireNonAsciiKeySequence(
        target: EventTarget,
        keyOrKeyCode: string|number,
        keyPressKeyOrKeyCode: string|number,
        opt_eventProperties?: Object
    ): boolean;
     ...
     */
    function fireMouseEnterEvent(
        target: EventTarget, relatedTarget: EventTarget|null, opt_coords?: goog.math.Coordinate
    ): boolean;
     ...
     *     called on it, true otherwise.
     */
    function fireMouseOverEvent(target: EventTarget, relatedTarget: EventTarget, opt_coords?: goog.math.Coordinate):
        boolean;
     ...
     *     called on it, true otherwise.
     */
    function fireMouseOutEvent(target: EventTarget, relatedTarget: EventTarget, opt_coords?: goog.math.Coordinate):
        boolean;
     ...
     *     called on it, true otherwise.
     */
    function fireDoubleClickEvent(target: EventTarget, opt_coords?: goog.math.Coordinate, opt_eventProperties?: Object):
        boolean;
     ...
     *     called on it, true otherwise.
     */
    function fireTouchStartEvent(target: EventTarget, opt_coords?: goog.math.Coordinate, opt_eventProperties?: Object):
        boolean;
     ...
     *     called on it, true otherwise.
     */
    function fireTouchMoveEvent(target: EventTarget, opt_coords?: goog.math.Coordinate, opt_eventProperties?: Object):
        boolean;
     ...
     *     called on it, true otherwise.
     */
    function fireTouchEndEvent(target: EventTarget, opt_coords?: goog.math.Coordinate, opt_eventProperties?: Object):
        boolean;
     ...
     *     was called on any of the events, true otherwise.
     */
    function fireTouchSequence(target: EventTarget, opt_coords?: goog.math.Coordinate, opt_eventProperties?: Object):
        boolean;

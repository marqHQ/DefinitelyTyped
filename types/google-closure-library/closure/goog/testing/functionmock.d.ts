...
declare namespace goog.testing {
     ...
     */
    function createConstructorMock(scope: Object, constructorName: string, opt_strictness?: number):
...
declare namespace goog.testing.MethodMock {
    /**
     * Mocks an existing function. Creates a goog.testing.FunctionMock
     ...
     * @return {!goog.testing.MockInterface} The mocked method.
     */
    function fromObjectPropertyString(scopeFunctionName: goog.testing.ObjectPropertyString, opt_strictness?: number):
        goog.testing.MockInterface;

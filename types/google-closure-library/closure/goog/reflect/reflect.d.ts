...
declare namespace goog.reflect {
     ...
     * @template V
     */
    function cache<V>(cacheObj: {[key: number]: V}, key: any, valueFn: (_0: any) => V, opt_keyFn?: (_0: any) => number):
        V;
    function cache<V>(cacheObj: {[key: string]: V}, key: any, valueFn: (_0: any) => V, opt_keyFn?: (_0: any) => string):
        V;
}

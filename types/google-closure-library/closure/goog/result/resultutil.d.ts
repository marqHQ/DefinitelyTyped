...
declare namespace goog.result {
    ...
    abstract class __DependentResultImpl_ extends goog.result.__SimpleResult implements goog.result.DependentResult {
        /**
         ...
         * @private
         */
        private parentResults_: goog.result.Result[];
     ...
     * @template T
     */
    function wait<T>(result: goog.result.Result, handler: (this: T, _0: goog.result.Result) => void, opt_scope?: T):
        void;
     ...
     * @template T
     */
    function waitOnSuccess<T>(
        result: goog.result.Result, handler: (this: T, _0: any, _1: goog.result.Result) => void, opt_scope?: T
    ): void;
    ...
    function chain<T>(
        ...
        actionCallback: (this: T, _0: goog.result.Result) => goog.result.Result,
        opt_scope?: T

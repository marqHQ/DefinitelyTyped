...
declare namespace goog.messaging {
     ...
     */
    class AbstractChannel extends __AbstractChannel {}
    abstract class __AbstractChannel extends goog.__Disposable implements goog.messaging.MessageChannel {
        /**
         */
        constructor();
         ...
         * @private
         */
        private services_: {[key: string]: {callback: (_0: string|Object) => void, objectPayload: boolean}};
        ...
        protected getService(serviceName: string, payload: string|Object): ({
            callback: (_0: string|Object) => void;
            objectPayload: boolean
        })|null;
         ...
         * @protected
         */
        protected decodePayload(serviceName: string, payload: string|Object, objectPayload: boolean): string|Object;

...
declare namespace goog.pubsub {
    ...
    abstract class __PubSub extends goog.__Disposable {
        /**
         ...
         * @const
         */
        private readonly pendingKeys_: any /*missing*/;
         ...
         * @private {number}
         */
        private publishDepth_: any /*missing*/;
         ...
         * @const
         */
        private readonly subscriptions_: any /*missing*/;
         ...
         */
        private topics_: any /*missing*/;

        /**
         * @private @const {boolean}
         */
        private async_: any /*missing*/;
...
declare namespace goog.pubsub.PubSub {
}

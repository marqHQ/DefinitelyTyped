...
declare namespace goog.dom.safe {
    ...
    function insertAdjacentHtml(
        node: Node, position: goog.dom.safe.InsertAdjacentHtmlPosition, html: goog.html.SafeHtml
    ): void;
    ...
    function setLinkHrefAndRel(
        link: HTMLLinkElement, url: string|goog.html.SafeUrl|goog.html.TrustedResourceUrl, rel: string
    ): void;
    ...
    function openInWindow(
        ...
        opt_openerWin?: Window,
        opt_name?: goog.string.Const,
        opt_specs?: string,
        opt_replace?: boolean
    ): Window;
}

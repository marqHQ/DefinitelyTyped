...
declare namespace goog.dom.annotate {
    ...
    interface AnnotateFn {
        (_0: number, _1: goog.html.SafeHtml): goog.html.SafeHtml;
    }
     ...
     */
    function annotateText(text: string, terms: any[][], annotateFn: goog.dom.annotate.AnnotateFn, opt_ignoreCase?: any):
        goog.html.SafeHtml;
}

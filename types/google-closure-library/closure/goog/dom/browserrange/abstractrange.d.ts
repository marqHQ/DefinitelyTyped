...
declare namespace goog.dom.browserrange {
    ...
    abstract class __AbstractRange {
        /**
         */
        constructor();
         ...
         * @private
         */
        private getPosition_(start: boolean): goog.math.Coordinate;
        ...
        compareBrowserRangeEndpoints(
            range: Range|TextRange, thisEndpoint: goog.dom.RangeEndpoint, otherEndpoint: goog.dom.RangeEndpoint
        ): number;

...
declare namespace goog.dom.forms {
     ...
     * @return {boolean} true If the form was submitted succesfully.
     */
    function submitFormDataInNewWindow(actionUri: string, method: string, formData: goog.structs.Map<string, string[]>):
        boolean;
     ...
     */
    function getFormDataMap(form: HTMLFormElement): goog.structs.Map<string, string[]>;
     ...
     *     (or null).
     */
    function getValue(el: Element): string|string[]|null;
     ...
     */
    function getValueByName(form: HTMLFormElement, name: string): string[]|string|null;

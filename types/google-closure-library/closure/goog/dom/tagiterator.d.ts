...
declare namespace goog.dom {
     ...
     */
    class TagIterator extends __TagIterator {}
    abstract class __TagIterator extends goog.iter.__Iterator<Node> {
        /**
         ...
         */
        setPosition(node: Node, opt_tagType?: goog.dom.TagWalkType|null, opt_depth?: number): void;
         ...
         * @protected
         */
        protected copyFrom(other: goog.dom.TagIterator): void;

...
declare namespace goog.math {
    ...
    abstract class __Rect implements goog.math.IRect {
        /**
         * @param {number} x Left.
         * @param {number} y Top.
         ...
         */
        difference(rect: goog.math.IRect): goog.math.Rect[];
...
declare namespace goog.math.Rect {
     ...
     *     size.
     */
    function createFromPositionAndSize(position: goog.math.Coordinate, size: goog.math.Size): goog.math.Rect;
     ...
     */
    function equals(a: goog.math.IRect, b: goog.math.IRect): boolean;
     ...
     */
    function intersection(a: goog.math.IRect, b: goog.math.IRect): goog.math.Rect;
     ...
     */
    function intersects(a: goog.math.IRect, b: goog.math.IRect): boolean;
     ...
     *     together define the difference area of rectangle a minus rectangle b.
     */
    function difference(a: goog.math.Rect, b: goog.math.IRect): goog.math.Rect[];
     ...
     *     null.
     */
    function boundingRect(a: goog.math.IRect, b: goog.math.IRect): goog.math.Rect;
}

...
declare namespace goog.math {
    ...
    abstract class __Integer {
         ...
         * @private
         */
        private slowDivide_(other: goog.math.Integer): goog.math.Integer;
...
declare namespace goog.math.Integer {
    /**
    ...
    let ZERO: goog.math.Integer;

    /** @type {!goog.math.Integer} */
    let ONE: goog.math.Integer;
}

...
declare namespace goog.vec.vec2f {
     ...
     * @return {!goog.vec.vec2f.Type} The new vec2f.
     */
    function createFromArray(vec: number[]): goog.vec.vec2f.Type;
     ...
     */
    function createFromValues(v0: number, v1: number): goog.vec.vec2f.Type;
     ...
     */
    function clone(vec: goog.vec.vec2f.Type): goog.vec.vec2f.Type;
     ...
     *     chained together.
     */
    function add(vec0: goog.vec.vec2f.Type, vec1: goog.vec.vec2f.Type, resultVec: goog.vec.vec2f.Type):
        goog.vec.vec2f.Type;
     ...
     *     chained together.
     */
    function subtract(vec0: goog.vec.vec2f.Type, vec1: goog.vec.vec2f.Type, resultVec: goog.vec.vec2f.Type):
        goog.vec.vec2f.Type;
     ...
     *     chained together.
     */
    function componentMultiply(vec0: goog.vec.vec2f.Type, vec1: goog.vec.vec2f.Type, resultVec: goog.vec.vec2f.Type):
        goog.vec.vec2f.Type;
     ...
     *     chained together.
     */
    function componentDivide(vec0: goog.vec.vec2f.Type, vec1: goog.vec.vec2f.Type, resultVec: goog.vec.vec2f.Type):
        goog.vec.vec2f.Type;
     ...
     *     chained together.
     */
    function direction(vec0: goog.vec.vec2f.Type, vec1: goog.vec.vec2f.Type, resultVec: goog.vec.vec2f.Type):
        goog.vec.vec2f.Type;
     ...
     *     chained together.
     */
    function lerp(vec0: goog.vec.vec2f.Type, vec1: goog.vec.vec2f.Type, f: number, resultVec: goog.vec.vec2f.Type):
        goog.vec.vec2f.Type;
     ...
     *     chained together.
     */
    function max(vec0: goog.vec.vec2f.Type, limit: goog.vec.vec2f.Type|number, resultVec: goog.vec.vec2f.Type):
        goog.vec.vec2f.Type;
     ...
     *     chained together.
     */
    function min(vec0: goog.vec.vec2f.Type, limit: goog.vec.vec2f.Type|number, resultVec: goog.vec.vec2f.Type):
        goog.vec.vec2f.Type;

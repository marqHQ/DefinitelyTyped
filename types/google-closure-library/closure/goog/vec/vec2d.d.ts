...
declare module 'goog:goog.vec.vec2d' {
    export = goog.vec.vec2d;
}

declare module 'goog:goog.vec.vec2d.Type' {
    import alias = goog.vec.vec2d.Type;
...
declare namespace goog.vec.vec2d {
     ...
     * @return {!goog.vec.vec2d.Type} The new vec2d.
     */
    function createFromArray(vec: number[]): goog.vec.vec2d.Type;
     ...
     */
    function createFromValues(v0: number, v1: number): goog.vec.vec2d.Type;
     ...
     */
    function clone(vec: goog.vec.vec2d.Type): goog.vec.vec2d.Type;
     ...
     *     chained together.
     */
    function add(vec0: goog.vec.vec2d.Type, vec1: goog.vec.vec2d.Type, resultVec: goog.vec.vec2d.Type):
        goog.vec.vec2d.Type;
     ...
     *     chained together.
     */
    function subtract(vec0: goog.vec.vec2d.Type, vec1: goog.vec.vec2d.Type, resultVec: goog.vec.vec2d.Type):
        goog.vec.vec2d.Type;
     ...
     *     chained together.
     */
    function componentMultiply(vec0: goog.vec.vec2d.Type, vec1: goog.vec.vec2d.Type, resultVec: goog.vec.vec2d.Type):
        goog.vec.vec2d.Type;
     ...
     *     chained together.
     */
    function componentDivide(vec0: goog.vec.vec2d.Type, vec1: goog.vec.vec2d.Type, resultVec: goog.vec.vec2d.Type):
        goog.vec.vec2d.Type;
     ...
     *     chained together.
     */
    function direction(vec0: goog.vec.vec2d.Type, vec1: goog.vec.vec2d.Type, resultVec: goog.vec.vec2d.Type):
        goog.vec.vec2d.Type;
     ...
     *     chained together.
     */
    function lerp(vec0: goog.vec.vec2d.Type, vec1: goog.vec.vec2d.Type, f: number, resultVec: goog.vec.vec2d.Type):
        goog.vec.vec2d.Type;
     ...
     *     chained together.
     */
    function max(vec0: goog.vec.vec2d.Type, limit: goog.vec.vec2d.Type|number, resultVec: goog.vec.vec2d.Type):
        goog.vec.vec2d.Type;
     ...
     *     chained together.
     */
    function min(vec0: goog.vec.vec2d.Type, limit: goog.vec.vec2d.Type|number, resultVec: goog.vec.vec2d.Type):
        goog.vec.vec2d.Type;

...
declare namespace goog.vec.Matrix4 {
    /**
     ...
     */
    function setColumnValues(mat: goog.vec.ArrayType, column: number, v0: number, v1: number, v2: number, v3: number):
        void;
     ...
     *     chained together.
     */
    function subtract(mat0: goog.vec.ArrayType, mat1: goog.vec.ArrayType, resultMat: goog.vec.ArrayType):
        goog.vec.ArrayType;
     ...
     *     chained together.
     */
    function multMat(mat0: goog.vec.ArrayType, mat1: goog.vec.ArrayType, resultMat: goog.vec.ArrayType):
        goog.vec.ArrayType;
     ...
     *     chained together.
     */
    function multVec3(mat: goog.vec.ArrayType, vec: goog.vec.ArrayType, resultVec: goog.vec.ArrayType):
        goog.vec.ArrayType;
     ...
     *     chained together.
     */
    function multVec3NoTranslate(mat: goog.vec.ArrayType, vec: goog.vec.ArrayType, resultVec: goog.vec.ArrayType):
        goog.vec.ArrayType;
     ...
     *     chained together.
     */
    function multVec3Projective(mat: goog.vec.ArrayType, vec: goog.vec.ArrayType, resultVec: goog.vec.ArrayType):
        goog.vec.ArrayType;
     ...
     *     chained together.
     */
    function multVec4(mat: goog.vec.ArrayType, vec: goog.vec.ArrayType, resultVec: goog.vec.ArrayType):
        goog.vec.ArrayType;
     ...
     *     chained together.
     */
    function multVec3ToArray(mat: goog.vec.ArrayType, vec: goog.vec.ArrayType, resultVec: goog.vec.ArrayType):
        goog.vec.ArrayType;
     ...
     *     chained together.
     */
    function multVec4ToArray(mat: goog.vec.ArrayType, vec: goog.vec.ArrayType, resultVec: goog.vec.ArrayType):
        goog.vec.ArrayType;
    ...
    function makeFrustum(
        mat: goog.vec.ArrayType, left: number, right: number, bottom: number, top: number, near: number, far: number
    ): void;

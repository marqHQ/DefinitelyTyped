...
declare module 'goog:goog.vec.vec4f' {
    export = goog.vec.vec4f;
}

declare module 'goog:goog.vec.vec4f.Type' {
    import alias = goog.vec.vec4f.Type;
    export default alias;
}

declare namespace goog.vec.vec4f {
     ...
     * @return {!goog.vec.vec4f.Type} The new vec4f.
     */
    function createFromArray(vec: number[]): goog.vec.vec4f.Type;
     ...
     */
    function createFromValues(v0: number, v1: number, v2: number, v3: number): goog.vec.vec4f.Type;
     ...
     */
    function clone(vec: goog.vec.vec4f.Type): goog.vec.vec4f.Type;
     ...
     *     chained together.
     */
    function setFromValues(vec: goog.vec.vec4f.Type, v0: number, v1: number, v2: number, v3: number):
        goog.vec.vec4f.Type;
     ...
     *     chained together.
     */
    function add(vec0: goog.vec.vec4f.Type, vec1: goog.vec.vec4f.Type, resultVec: goog.vec.vec4f.Type):
        goog.vec.vec4f.Type;
     ...
     *     chained together.
     */
    function subtract(vec0: goog.vec.vec4f.Type, vec1: goog.vec.vec4f.Type, resultVec: goog.vec.vec4f.Type):
        goog.vec.vec4f.Type;
     ...
     *     chained together.
     */
    function lerp(v0: goog.vec.vec4f.Type, v1: goog.vec.vec4f.Type, f: number, resultVec: goog.vec.vec4f.Type):
        goog.vec.vec4f.Type;
     ...
     *     chained together.
     */
    function max(vec0: goog.vec.vec4f.Type, limit: goog.vec.vec4f.Type|number, resultVec: goog.vec.vec4f.Type):
        goog.vec.vec4f.Type;
     ...
     *     chained together.
     */
    function min(vec0: goog.vec.vec4f.Type, limit: goog.vec.vec4f.Type|number, resultVec: goog.vec.vec4f.Type):
        goog.vec.vec4f.Type;

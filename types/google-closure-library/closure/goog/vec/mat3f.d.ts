...
declare namespace goog.vec.mat3f {
     ...
     * @return {!goog.vec.mat3f.Type} The new mat3f.
     */
    function createIdentity(): goog.vec.mat3f.Type;
     ...
     *     chained together.
     */
    function setColumnValues(mat: goog.vec.mat3f.Type, column: number, v0: number, v1: number, v2: number):
        goog.vec.mat3f.Type;
     ...
     */
    function setColumns(
        mat: goog.vec.mat3f.Type, vec0: goog.vec.vec3f.Type, vec1: goog.vec.vec3f.Type, vec2: goog.vec.vec3f.Type
    ): goog.vec.mat3f.Type;
     ...
     *     chained together.
     */
    function setRowValues(mat: goog.vec.mat3f.Type, row: number, v0: number, v1: number, v2: number):
        goog.vec.mat3f.Type;
     ...
     *     chained together.
     */
    function addMat(mat0: goog.vec.mat3f.Type, mat1: goog.vec.mat3f.Type, resultMat: goog.vec.mat3f.Type):
        goog.vec.mat3f.Type;
     ...
     *     chained together.
     */
    function subMat(mat0: goog.vec.mat3f.Type, mat1: goog.vec.mat3f.Type, resultMat: goog.vec.mat3f.Type):
        goog.vec.mat3f.Type;
     ...
     *     chained together.
     */
    function multMat(mat0: goog.vec.mat3f.Type, mat1: goog.vec.mat3f.Type, resultMat: goog.vec.mat3f.Type):
        goog.vec.mat3f.Type;
     ...
     *     chained together.
     */
    function multVec3(mat: goog.vec.mat3f.Type, vec: goog.vec.vec3f.Type, resultVec: goog.vec.vec3f.Type):
        goog.vec.vec3f.Type;
     ...
     *     chained.
     */
    function makeRotate(mat: goog.vec.mat3f.Type, angle: number, ax: number, ay: number, az: number):
        goog.vec.mat3f.Type;
     ...
     *     chained.
     */
    function makeEulerZXZ(mat: goog.vec.mat3f.Type, theta1: number, theta2: number, theta3: number):
        goog.vec.mat3f.Type;
     ...
     *     chained together.
     */
    function toEulerZXZ(mat: goog.vec.mat3f.Type, euler: goog.vec.vec3f.Type, opt_theta2IsNegative?: boolean):
        goog.vec.vec3f.Type;
}

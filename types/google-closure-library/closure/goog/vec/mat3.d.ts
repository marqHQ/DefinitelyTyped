...
declare module 'goog:goog.vec.Mat3' {
    import alias = goog.vec.Mat3;
    export default alias;
}

declare namespace goog.vec.Mat3 {
     ...
     *     chained together.
     */
    function setDiagonalValues(mat: goog.vec.Mat3.AnyType, v00: number, v11: number, v22: number):
        goog.vec.Mat3.AnyType;
     ...
     *     chained together.
     */
    function setColumnValues(mat: goog.vec.Mat3.AnyType, column: number, v0: number, v1: number, v2: number):
        goog.vec.Mat3.AnyType;
     ...
     *     chained together.
     */
    function setRowValues(mat: goog.vec.Mat3.AnyType, row: number, v0: number, v1: number, v2: number):
        goog.vec.Mat3.AnyType;
     ...
     *     chained together.
     */
    function addMat(mat0: goog.vec.Mat3.AnyType, mat1: goog.vec.Mat3.AnyType, resultMat: goog.vec.Mat3.AnyType):
        goog.vec.Mat3.AnyType;
     ...
     *     chained together.
     */
    function subMat(mat0: goog.vec.Mat3.AnyType, mat1: goog.vec.Mat3.AnyType, resultMat: goog.vec.Mat3.AnyType):
        goog.vec.Mat3.AnyType;
     ...
     *     chained together.
     */
    function multScalar(mat: goog.vec.Mat3.AnyType, scalar: number, resultMat: goog.vec.Mat3.AnyType):
        goog.vec.Mat3.AnyType;
     ...
     *     chained together.
     */
    function multMat(mat0: goog.vec.Mat3.AnyType, mat1: goog.vec.Mat3.AnyType, resultMat: goog.vec.Mat3.AnyType):
        goog.vec.Mat3.AnyType;
     ...
     *     chained together.
     */
    function multVec3(mat: goog.vec.Mat3.AnyType, vec: goog.vec.Vec3.AnyType, resultVec: goog.vec.Vec3.AnyType):
     ...
     *     chained.
     */
    function makeRotate(mat: goog.vec.Mat3.AnyType, angle: number, ax: number, ay: number, az: number):
        goog.vec.Mat3.AnyType;
     ...
     *     chained.
     */
    function makeEulerZXZ(mat: goog.vec.Mat3.AnyType, theta1: number, theta2: number, theta3: number):
        goog.vec.Mat3.AnyType;
     ...
     *     chained together.
     */
    function toEulerZXZ(mat: goog.vec.Mat3.AnyType, euler: goog.vec.Vec3.AnyType, opt_theta2IsNegative?: boolean):
        goog.vec.Vec3.AnyType;
}

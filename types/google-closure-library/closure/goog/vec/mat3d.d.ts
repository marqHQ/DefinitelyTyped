...
declare namespace goog.vec.mat3d {
     ...
     * @return {!goog.vec.mat3d.Type} The new mat3d.
     */
    function createIdentity(): goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function setColumnValues(mat: goog.vec.mat3d.Type, column: number, v0: number, v1: number, v2: number):
        goog.vec.mat3d.Type;
     ...
     */
    function setColumns(
        mat: goog.vec.mat3d.Type, vec0: goog.vec.vec3d.Type, vec1: goog.vec.vec3d.Type, vec2: goog.vec.vec3d.Type
    ): goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function setRowValues(mat: goog.vec.mat3d.Type, row: number, v0: number, v1: number, v2: number):
        goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function addMat(mat0: goog.vec.mat3d.Type, mat1: goog.vec.mat3d.Type, resultMat: goog.vec.mat3d.Type):
        goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function subMat(mat0: goog.vec.mat3d.Type, mat1: goog.vec.mat3d.Type, resultMat: goog.vec.mat3d.Type):
        goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function multMat(mat0: goog.vec.mat3d.Type, mat1: goog.vec.mat3d.Type, resultMat: goog.vec.mat3d.Type):
        goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function multVec3(mat: goog.vec.mat3d.Type, vec: goog.vec.vec3d.Type, resultVec: goog.vec.vec3d.Type):
        goog.vec.vec3d.Type;
     ...
     *     chained.
     */
    function makeRotate(mat: goog.vec.mat3d.Type, angle: number, ax: number, ay: number, az: number):
        goog.vec.mat3d.Type;
     ...
     *     chained.
     */
    function makeEulerZXZ(mat: goog.vec.mat3d.Type, theta1: number, theta2: number, theta3: number):
        goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function toEulerZXZ(mat: goog.vec.mat3d.Type, euler: goog.vec.vec3d.Type, opt_theta2IsNegative?: boolean):
        goog.vec.vec3d.Type;
}

...
declare namespace goog.vec.Quaternion {
     ...
     *     chained together.
     */
    function setFromValues(q: goog.vec.Quaternion.AnyType, v0: number, v1: number, v2: number, v3: number):
     ...
     */
    function add(
        quat0: goog.vec.Quaternion.AnyType, quat1: goog.vec.Quaternion.AnyType, resultQuat: goog.vec.Quaternion.AnyType
    ): void;
     ...
     */
    function invert(quat: goog.vec.Quaternion.AnyType, resultQuat: goog.vec.Quaternion.AnyType):
     ...
     *     operations can be chained together.
     */
    function conjugate(quat: goog.vec.Quaternion.AnyType, resultQuat: goog.vec.Quaternion.AnyType):
        goog.vec.Quaternion.AnyType;
     ...
     *     operations can be chained together.
     */
    function fromAngleAxis(angle: number, axis: goog.vec.Quaternion.AnyType, quat: goog.vec.Quaternion.AnyType):
        goog.vec.Quaternion.AnyType;
     ...
     *     operations can be chained together.
     */
    function fromRotationMatrix3(matrix: goog.vec.AnyType, quat: goog.vec.Quaternion.AnyType):
        goog.vec.Quaternion.AnyType;
     ...
     *     operations can be chained together.
     */
    function fromRotationMatrix4(matrix: goog.vec.AnyType, quat: goog.vec.Quaternion.AnyType):
        goog.vec.Quaternion.AnyType;
     ...
     *     operations can be chained together.
     */
    function rotateX(quat: goog.vec.Quaternion.AnyType, angle: number, resultQuat: goog.vec.Quaternion.AnyType):
        goog.vec.Quaternion.AnyType;
     ...
     *     operations can be chained together.
     */
    function rotateY(quat: goog.vec.Quaternion.AnyType, angle: number, resultQuat: goog.vec.Quaternion.AnyType):
        goog.vec.Quaternion.AnyType;
     ...
     *     operations can be chained together.
     */
    function rotateZ(quat: goog.vec.Quaternion.AnyType, angle: number, resultQuat: goog.vec.Quaternion.AnyType):
        goog.vec.Quaternion.AnyType;
     ...
     */
    function transformVec(vec: goog.vec.AnyType, quat: goog.vec.Quaternion.AnyType, resultVec: goog.vec.AnyType):
        goog.vec.AnyType;

...
declare namespace goog.vec.Mat4 {
     ...
     *     chained together.
     */
    function setDiagonalValues(mat: goog.vec.Mat4.AnyType, v00: number, v11: number, v22: number, v33: number):
        goog.vec.Mat4.AnyType;
     ...
     *     chained together.
     */
    function getDiagonal(mat: goog.vec.Mat4.AnyType, vec: goog.vec.Vec4.AnyType, opt_diagonal?: number):
    ...
    function setColumnValues(
        mat: goog.vec.Mat4.AnyType, column: number, v0: number, v1: number, v2: number, v3: number
    ): goog.vec.Mat4.AnyType;
     ...
     *     chained together.
     */
    function setRowValues(mat: goog.vec.Mat4.AnyType, row: number, v0: number, v1: number, v2: number, v3: number):
        goog.vec.Mat4.AnyType;
     ...
     *     chained together.
     */
    function addMat(mat0: goog.vec.Mat4.AnyType, mat1: goog.vec.Mat4.AnyType, resultMat: goog.vec.Mat4.AnyType):
        goog.vec.Mat4.AnyType;
     ...
     *     chained together.
     */
    function subMat(mat0: goog.vec.Mat4.AnyType, mat1: goog.vec.Mat4.AnyType, resultMat: goog.vec.Mat4.AnyType):
        goog.vec.Mat4.AnyType;
     ...
     *     chained together.
     */
    function multScalar(mat: goog.vec.Mat4.AnyType, scalar: number, resultMat: goog.vec.Mat4.AnyType):
        goog.vec.Mat4.AnyType;
     ...
     *     chained together.
     */
    function multMat(mat0: goog.vec.Mat4.AnyType, mat1: goog.vec.Mat4.AnyType, resultMat: goog.vec.Mat4.AnyType):
        goog.vec.Mat4.AnyType;
     ...
     *     chained together.
     */
    function multVec3(mat: goog.vec.Mat4.AnyType, vec: goog.vec.Vec3.AnyType, resultVec: goog.vec.Vec3.AnyType):
    ...
    function multVec3NoTranslate(
        mat: goog.vec.Mat4.AnyType, vec: goog.vec.Vec3.AnyType, resultVec: goog.vec.Vec3.AnyType
    ): goog.vec.Vec3.AnyType;
     ...
     *     chained together.
     */
    function multVec4(mat: goog.vec.Mat4.AnyType, vec: goog.vec.Vec4.AnyType, resultVec: goog.vec.Vec4.AnyType):
        goog.vec.Vec4.AnyType;
     ...
     *     chained.
     */
    function makeRotate(mat: goog.vec.Mat4.AnyType, angle: number, ax: number, ay: number, az: number):
        goog.vec.Mat4.AnyType;
    ...
    function makeFrustum(
        mat: goog.vec.Mat4.AnyType, left: number, right: number, bottom: number, top: number, near: number, far: number
    ): goog.vec.Mat4.AnyType;
     ...
     *     chained.
     */
    function makePerspective(mat: goog.vec.Mat4.AnyType, fovy: number, aspect: number, near: number, far: number):
        goog.vec.Mat4.AnyType;
     ...
     *     chained.
     */
    function makeEulerZXZ(mat: goog.vec.Mat4.AnyType, theta1: number, theta2: number, theta3: number):
        goog.vec.Mat4.AnyType;
     ...
     *     chained together.
     */
    function toEulerZXZ(mat: goog.vec.Mat4.AnyType, euler: goog.vec.Vec3.AnyType, opt_theta2IsNegative?: boolean):
        goog.vec.Vec4.AnyType;

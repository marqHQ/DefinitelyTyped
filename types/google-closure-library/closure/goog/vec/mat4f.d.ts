...
declare namespace goog.vec.mat4f {
     ...
     * @return {!goog.vec.mat4f.Type} The new mat4f.
     */
    function createIdentity(): goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function setDiagonalValues(mat: goog.vec.mat4f.Type, v00: number, v11: number, v22: number, v33: number):
        goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function getDiagonal(mat: goog.vec.mat4f.Type, vec: goog.vec.vec4f.Type, opt_diagonal?: number):
        goog.vec.vec4f.Type;
     ...
     *     chained together.
     */
    function setColumnValues(mat: goog.vec.mat4f.Type, column: number, v0: number, v1: number, v2: number, v3: number):
        goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function setRowValues(mat: goog.vec.mat4f.Type, row: number, v0: number, v1: number, v2: number, v3: number):
        goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function addMat(mat0: goog.vec.mat4f.Type, mat1: goog.vec.mat4f.Type, resultMat: goog.vec.mat4f.Type):
        goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function subMat(mat0: goog.vec.mat4f.Type, mat1: goog.vec.mat4f.Type, resultMat: goog.vec.mat4f.Type):
        goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function multMat(mat0: goog.vec.mat4f.Type, mat1: goog.vec.mat4f.Type, resultMat: goog.vec.mat4f.Type):
        goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function multVec3(mat: goog.vec.mat4f.Type, vec: goog.vec.vec3f.Type, resultVec: goog.vec.vec3f.Type):
        goog.vec.vec3f.Type;
     ...
     *     chained together.
     */
    function multVec3NoTranslate(mat: goog.vec.mat4f.Type, vec: goog.vec.vec3f.Type, resultVec: goog.vec.vec3f.Type):
        goog.vec.vec3f.Type;
     ...
     *     chained together.
     */
    function multVec3Projective(mat: goog.vec.mat4f.Type, vec: goog.vec.vec3f.Type, resultVec: goog.vec.vec3f.Type):
        goog.vec.vec3f.Type;
     ...
     *     chained together.
     */
    function multVec4(mat: goog.vec.mat4f.Type, vec: goog.vec.vec4f.Type, resultVec: goog.vec.vec4f.Type):
        goog.vec.vec4f.Type;
     ...
     *     chained.
     */
    function makeRotate(mat: goog.vec.mat4f.Type, angle: number, ax: number, ay: number, az: number):
        goog.vec.mat4f.Type;
    ...
    function makeRotationTranslation(
        mat: goog.vec.mat4f.Type, rotation: goog.vec.Quaternion.AnyType, translation: goog.vec.vec3f.Type
    ): goog.vec.mat4f.Type;
    ...
    function makeFrustum(
        mat: goog.vec.mat4f.Type, left: number, right: number, bottom: number, top: number, near: number, far: number
    ): goog.vec.mat4f.Type;
     ...
     *     chained.
     */
    function makePerspective(mat: goog.vec.mat4f.Type, fovy: number, aspect: number, near: number, far: number):
        goog.vec.mat4f.Type;
     ...
     *     chained.
     */
    function makeEulerZXZ(mat: goog.vec.mat4f.Type, theta1: number, theta2: number, theta3: number):
        goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function toEulerZXZ(mat: goog.vec.mat4f.Type, euler: goog.vec.vec3f.Type, opt_theta2IsNegative?: boolean):
        goog.vec.vec4f.Type;

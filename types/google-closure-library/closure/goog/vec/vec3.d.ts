...
declare module 'goog:goog.vec.Vec3' {
    import alias = goog.vec.Vec3;
    export default alias;
}

declare namespace goog.vec.Vec3 {
     ...
     *     chained together.
     */
    function add(vec0: goog.vec.Vec3.AnyType, vec1: goog.vec.Vec3.AnyType, resultVec: goog.vec.Vec3.AnyType):
     ...
     *     chained together.
     */
    function subtract(vec0: goog.vec.Vec3.AnyType, vec1: goog.vec.Vec3.AnyType, resultVec: goog.vec.Vec3.AnyType):
        goog.vec.Vec3.AnyType;
     ...
     *     chained together.
     */
    function scale(vec0: goog.vec.Vec3.AnyType, scalar: number, resultVec: goog.vec.Vec3.AnyType):
        goog.vec.Vec3.AnyType;
     ...
     *     chained together.
     */
    function cross(v0: goog.vec.Vec3.AnyType, v1: goog.vec.Vec3.AnyType, resultVec: goog.vec.Vec3.AnyType):
        goog.vec.Vec3.AnyType;
     ...
     *     chained together.
     */
    function direction(vec0: goog.vec.Vec3.AnyType, vec1: goog.vec.Vec3.AnyType, resultVec: goog.vec.Vec3.AnyType):
        goog.vec.Vec3.AnyType;
     ...
     *     chained together.
     */
    function lerp(v0: goog.vec.Vec3.AnyType, v1: goog.vec.Vec3.AnyType, f: number, resultVec: goog.vec.Vec3.AnyType):
        goog.vec.Vec3.AnyType;
     ...
     *     chained together.
     */
    function max(vec0: goog.vec.Vec3.AnyType, limit: goog.vec.Vec3.AnyType|number, resultVec: goog.vec.Vec3.AnyType):
        goog.vec.Vec3.AnyType;
     ...
     *     chained together.
     */
    function min(vec0: goog.vec.Vec3.AnyType, limit: goog.vec.Vec3.AnyType|number, resultVec: goog.vec.Vec3.AnyType):
        goog.vec.Vec3.AnyType;

...
declare namespace goog.vec.vec3d {
     ...
     * @return {!goog.vec.vec3d.Type} The new vec3d.
     */
    function createFromArray(vec: number[]): goog.vec.vec3d.Type;
     ...
     */
    function createFromValues(v0: number, v1: number, v2: number): goog.vec.vec3d.Type;
     ...
     */
    function clone(vec: goog.vec.vec3d.Type): goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function add(vec0: goog.vec.vec3d.Type, vec1: goog.vec.vec3d.Type, resultVec: goog.vec.vec3d.Type):
        goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function subtract(vec0: goog.vec.vec3d.Type, vec1: goog.vec.vec3d.Type, resultVec: goog.vec.vec3d.Type):
        goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function cross(v0: goog.vec.vec3d.Type, v1: goog.vec.vec3d.Type, resultVec: goog.vec.vec3d.Type):
        goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function direction(vec0: goog.vec.vec3d.Type, vec1: goog.vec.vec3d.Type, resultVec: goog.vec.vec3d.Type):
        goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function lerp(v0: goog.vec.vec3d.Type, v1: goog.vec.vec3d.Type, f: number, resultVec: goog.vec.vec3d.Type):
        goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function slerp(v0: goog.vec.vec3d.Type, v1: goog.vec.vec3d.Type, f: number, resultVec: goog.vec.vec3d.Type):
        goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function max(vec0: goog.vec.vec3d.Type, limit: goog.vec.vec3d.Type|number, resultVec: goog.vec.vec3d.Type):
        goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function min(vec0: goog.vec.vec3d.Type, limit: goog.vec.vec3d.Type|number, resultVec: goog.vec.vec3d.Type):
        goog.vec.vec3d.Type;

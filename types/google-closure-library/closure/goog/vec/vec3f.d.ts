...
declare module 'goog:goog.vec.vec3f.Type' {
    import alias = goog.vec.vec3f.Type;
    export default alias;
}

declare namespace goog.vec.vec3f {
     ...
     * @return {!goog.vec.vec3f.Type} The new vec3f.
     */
    function createFromArray(vec: number[]): goog.vec.vec3f.Type;
     ...
     *     chained together.
     */
    function add(vec0: goog.vec.vec3f.Type, vec1: goog.vec.vec3f.Type, resultVec: goog.vec.vec3f.Type):
        goog.vec.vec3f.Type;
     ...
     *     chained together.
     */
    function subtract(vec0: goog.vec.vec3f.Type, vec1: goog.vec.vec3f.Type, resultVec: goog.vec.vec3f.Type):
        goog.vec.vec3f.Type;
     ...
     *     chained together.
     */
    function cross(v0: goog.vec.vec3f.Type, v1: goog.vec.vec3f.Type, resultVec: goog.vec.vec3f.Type):
        goog.vec.vec3f.Type;
     ...
     *     chained together.
     */
    function direction(vec0: goog.vec.vec3f.Type, vec1: goog.vec.vec3f.Type, resultVec: goog.vec.vec3f.Type):
        goog.vec.vec3f.Type;
     ...
     *     chained together.
     */
    function lerp(v0: goog.vec.vec3f.Type, v1: goog.vec.vec3f.Type, f: number, resultVec: goog.vec.vec3f.Type):
        goog.vec.vec3f.Type;
     ...
     *     chained together.
     */
    function slerp(v0: goog.vec.vec3f.Type, v1: goog.vec.vec3f.Type, f: number, resultVec: goog.vec.vec3f.Type):
        goog.vec.vec3f.Type;
     ...
     *     chained together.
     */
    function max(vec0: goog.vec.vec3f.Type, limit: goog.vec.vec3f.Type|number, resultVec: goog.vec.vec3f.Type):
        goog.vec.vec3f.Type;
     ...
     *     chained together.
     */
    function min(vec0: goog.vec.vec3f.Type, limit: goog.vec.vec3f.Type|number, resultVec: goog.vec.vec3f.Type):
        goog.vec.vec3f.Type;

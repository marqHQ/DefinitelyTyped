...
declare module 'goog:goog.vec.Vec2' {
    import alias = goog.vec.Vec2;
    export default alias;
}

declare namespace goog.vec.Vec2 {
     ...
     *     chained together.
     */
    function add(vec0: goog.vec.Vec2.AnyType, vec1: goog.vec.Vec2.AnyType, resultVec: goog.vec.Vec2.AnyType):
     ...
     *     chained together.
     */
    function subtract(vec0: goog.vec.Vec2.AnyType, vec1: goog.vec.Vec2.AnyType, resultVec: goog.vec.Vec2.AnyType):
        goog.vec.Vec2.AnyType;
     ...
     *     chained together.
     */
    function scale(vec0: goog.vec.Vec2.AnyType, scalar: number, resultVec: goog.vec.Vec2.AnyType):
        goog.vec.Vec2.AnyType;
     ...
     *     chained together.
     */
    function direction(vec0: goog.vec.Vec2.AnyType, vec1: goog.vec.Vec2.AnyType, resultVec: goog.vec.Vec2.AnyType):
        goog.vec.Vec2.AnyType;
     ...
     */
    function lerp(
        vec0: goog.vec.Vec2.AnyType, vec1: goog.vec.Vec2.AnyType, f: number, resultVec: goog.vec.Vec2.AnyType
    ): goog.vec.Vec2.AnyType;
     ...
     *     chained together.
     */
    function max(vec0: goog.vec.Vec2.AnyType, limit: goog.vec.Vec2.AnyType|number, resultVec: goog.vec.Vec2.AnyType):
        goog.vec.Vec2.AnyType;
     ...
     *     chained together.
     */
    function min(vec0: goog.vec.Vec2.AnyType, limit: goog.vec.Vec2.AnyType|number, resultVec: goog.vec.Vec2.AnyType):
        goog.vec.Vec2.AnyType;

...
declare module 'goog:goog.vec.mat4d' {
    export = goog.vec.mat4d;
}

declare module 'goog:goog.vec.mat4d.Type' {
    import alias = goog.vec.mat4d.Type;
...
declare namespace goog.vec.mat4d {
     ...
     * @return {!goog.vec.mat4d.Type} The new mat4d.
     */
    function createIdentity(): goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    function setDiagonalValues(mat: goog.vec.mat4d.Type, v00: number, v11: number, v22: number, v33: number):
        goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    function getDiagonal(mat: goog.vec.mat4d.Type, vec: goog.vec.vec4d.Type, opt_diagonal?: number):
        goog.vec.vec4d.Type;
     ...
     *     chained together.
     */
    function setColumnValues(mat: goog.vec.mat4d.Type, column: number, v0: number, v1: number, v2: number, v3: number):
        goog.vec.mat4d.Type;
    ...
    function setColumns(
        mat: goog.vec.mat4d.Type,
        vec0: goog.vec.vec4d.Type,
        vec1: goog.vec.vec4d.Type,
        vec2: goog.vec.vec4d.Type,
        vec3: goog.vec.vec4d.Type
    ): goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    function setRowValues(mat: goog.vec.mat4d.Type, row: number, v0: number, v1: number, v2: number, v3: number):
        goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    function addMat(mat0: goog.vec.mat4d.Type, mat1: goog.vec.mat4d.Type, resultMat: goog.vec.mat4d.Type):
        goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    function subMat(mat0: goog.vec.mat4d.Type, mat1: goog.vec.mat4d.Type, resultMat: goog.vec.mat4d.Type):
        goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    function multMat(mat0: goog.vec.mat4d.Type, mat1: goog.vec.mat4d.Type, resultMat: goog.vec.mat4d.Type):
        goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    function multVec3(mat: goog.vec.mat4d.Type, vec: goog.vec.vec3d.Type, resultVec: goog.vec.vec3d.Type):
        goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function multVec3NoTranslate(mat: goog.vec.mat4d.Type, vec: goog.vec.vec3d.Type, resultVec: goog.vec.vec3d.Type):
        goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function multVec3Projective(mat: goog.vec.mat4d.Type, vec: goog.vec.vec3d.Type, resultVec: goog.vec.vec3d.Type):
        goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function multVec4(mat: goog.vec.mat4d.Type, vec: goog.vec.vec4d.Type, resultVec: goog.vec.vec4d.Type):
        goog.vec.vec4d.Type;
     ...
     *     chained.
     */
    function makeRotate(mat: goog.vec.mat4d.Type, angle: number, ax: number, ay: number, az: number):
        goog.vec.mat4d.Type;
    ...
    function makeRotationTranslation(
        mat: goog.vec.mat4d.Type, rotation: goog.vec.Quaternion.AnyType, translation: goog.vec.vec3d.Type
    ): goog.vec.mat4d.Type;
    ...
    function makeRotationTranslationScale(
        mat: goog.vec.mat4d.Type,
        rotation: goog.vec.Quaternion.AnyType,
        translation: goog.vec.vec3d.Type,
        scale: goog.vec.vec3d.Type
    ): goog.vec.mat4d.Type;
    ...
    function makeFrustum(
        mat: goog.vec.mat4d.Type, left: number, right: number, bottom: number, top: number, near: number, far: number
    ): goog.vec.mat4d.Type;
     ...
     *     chained.
     */
    function makePerspective(mat: goog.vec.mat4d.Type, fovy: number, aspect: number, near: number, far: number):
        goog.vec.mat4d.Type;
    ...
    function makeLookAt(
        mat: goog.vec.mat4d.Type,
        eyePt: goog.vec.vec3d.Type,
        centerPt: goog.vec.vec3d.Type,
        worldUpVec: goog.vec.vec3d.Type
    ): goog.vec.mat4d.Type;
     ...
     *     chained.
     */
    function makeEulerZXZ(mat: goog.vec.mat4d.Type, theta1: number, theta2: number, theta3: number):
        goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    function toEulerZXZ(mat: goog.vec.mat4d.Type, euler: goog.vec.vec3d.Type, opt_theta2IsNegative?: boolean):
        goog.vec.vec4d.Type;

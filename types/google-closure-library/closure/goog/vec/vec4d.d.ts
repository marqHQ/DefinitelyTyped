...
declare module 'goog:goog.vec.vec4d' {
    export = goog.vec.vec4d;
}

declare module 'goog:goog.vec.vec4d.Type' {
    import alias = goog.vec.vec4d.Type;
    export default alias;
}

declare namespace goog.vec.vec4d {
     ...
     * @return {!goog.vec.vec4d.Type} The new vec4d.
     */
    function createFromArray(vec: number[]): goog.vec.vec4d.Type;
     ...
     *     chained together.
     */
    function setFromValues(vec: goog.vec.vec4d.Type, v0: number, v1: number, v2: number, v3: number):
        goog.vec.vec4d.Type;
     ...
     *     chained together.
     */
    function add(vec0: goog.vec.vec4d.Type, vec1: goog.vec.vec4d.Type, resultVec: goog.vec.vec4d.Type):
        goog.vec.vec4d.Type;
     ...
     *     chained together.
     */
    function subtract(vec0: goog.vec.vec4d.Type, vec1: goog.vec.vec4d.Type, resultVec: goog.vec.vec4d.Type):
        goog.vec.vec4d.Type;
     ...
     *     chained together.
     */
    function lerp(v0: goog.vec.vec4d.Type, v1: goog.vec.vec4d.Type, f: number, resultVec: goog.vec.vec4d.Type):
        goog.vec.vec4d.Type;
     ...
     *     chained together.
     */
    function max(vec0: goog.vec.vec4d.Type, limit: goog.vec.vec4d.Type|number, resultVec: goog.vec.vec4d.Type):
        goog.vec.vec4d.Type;
     ...
     *     chained together.
     */
    function min(vec0: goog.vec.vec4d.Type, limit: goog.vec.vec4d.Type|number, resultVec: goog.vec.vec4d.Type):
        goog.vec.vec4d.Type;

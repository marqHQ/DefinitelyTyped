...
declare namespace goog.string {
    ...
    abstract class __Const implements goog.string.TypedString {
        /**
         */
        constructor();
         ...
         * @private {string}
         */
        private stringConstValueWithSecurityContract__googStringSecurityPrivate_: any /*missing*/;
         ...
         * @private
         */
        private readonly STRING_CONST_TYPE_MARKER__GOOG_STRING_SECURITY_PRIVATE_: any /*missing*/;
...
declare namespace goog._string.Const {
    /**

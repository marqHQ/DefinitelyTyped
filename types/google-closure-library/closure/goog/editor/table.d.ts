...
declare namespace goog.editor {
    ...
    abstract class __TableCell {
         ...
         * @private
         */
        private updateCoordinates_(): void;
...
declare namespace goog.editor.Table {
    /**
     ...
     * @type {number}
     */
    let OPTIMUM_EMPTY_CELL_WIDTH: number;

    /**
     * Maximum width for new tables.
     * @type {number}
     */
    let OPTIMUM_MAX_NEW_TABLE_WIDTH: number;

...
declare namespace goog.editor.range {
    ...
    abstract class __NormalizedCaretRange_ extends goog.dom.__SavedCaretRange {
        /**
     ...
     */
    function rangePreservingNormalize(node: Node, range: goog.dom.AbstractRange|null): goog.dom.AbstractRange|null;
...
declare namespace goog.editor.range.Point {
    /**
     ...
     */
    function createDeepestPoint(
        node: Node, offset: number, opt_trendLeft?: boolean, opt_stopOnChildlessElement?: boolean

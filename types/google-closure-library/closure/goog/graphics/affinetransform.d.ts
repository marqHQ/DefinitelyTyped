...
declare module 'goog:goog.graphics.AffineTransform' {
    import alias = goog.graphics.AffineTransform;
...
declare namespace goog.graphics {
    ...
    abstract class __AffineTransform {
        /**
         ...
         */
        constructor(
            opt_m00?: number, opt_m10?: number, opt_m01?: number, opt_m11?: number, opt_m02?: number, opt_m12?: number
        );
         ...
         */
        setTransform(m00: number, m10: number, m01: number, m11: number, m02: number, m12: number):
...
declare namespace goog.graphics.AffineTransform {
    /**

...
declare module 'goog:goog.graphics.paths' {
    export = goog.graphics.paths;
}

declare namespace goog.graphics.paths {
    /**
     ...
     */
    function createRegularNGon(center: goog.math.Coordinate, vertex: goog.math.Coordinate, n: number):
        goog.graphics.Path;
     ...
     * @return {!goog.graphics.Path} The path.
     */
    function createArrow(a: goog.math.Coordinate, b: goog.math.Coordinate, aHead: number|null, bHead: number|null):
        goog.graphics.Path;
}

...
declare namespace goog.graphics {
    ...
    abstract class __AbstractGraphics extends goog.ui.__Component {
        /**
         ...
         * @protected
         */
        protected canvasElement: goog.graphics.GroupElement|null;
         ...
         */
        setElementFill(element: goog.graphics.StrokeAndFillElement, fill: goog.graphics.Fill|null): void;
         ...
         */
        setElementStroke(element: goog.graphics.StrokeAndFillElement, stroke: goog.graphics.Stroke|null): void;
         ...
         */
        setElementTransform(
            element: goog.graphics.Element, x: number, y: number, angle: number, centerX: number, centerY: number
        ): void;

...
declare namespace goog.graphics {
    ...
    abstract class __VmlGraphics extends goog.graphics.__AbstractGraphics {
        /**
         ...
         * @private
         */
        private handler_: goog.events.EventHandler<any>;
         ...
         * @private
         */
        private createFullSizeElement_(type: string): Element;

        /**
         * Changes the canvas element size to match the container element size.
         * @private
         */
        private handleContainerResize_(): void;
         ...
         * @private
         */
        private handlePropertyChange_(e: goog.events.BrowserEvent): void;
...
declare namespace goog.graphics.VmlGraphics {
    /**
     * The coordinate multiplier to allow sub-pixel rendering
     * @type {number}
     */
    let COORD_MULTIPLIER: number;

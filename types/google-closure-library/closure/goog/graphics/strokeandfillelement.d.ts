...
declare module 'goog:goog.graphics.StrokeAndFillElement' {
    import alias = goog.graphics.StrokeAndFillElement;
...
declare namespace goog.graphics {
    ...
    abstract class __StrokeAndFillElement extends goog.graphics.__Element {
        /**
         ...
         * @protected
         */
        protected fill: goog.graphics.Fill|null;
         ...
         * @private
         */
        private stroke_: goog.graphics.Stroke|null;
         ...
         */
        getFill(): goog.graphics.Fill|null;
         ...
         */
        getStroke(): goog.graphics.Stroke|null;

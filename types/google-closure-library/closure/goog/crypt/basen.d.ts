...
declare namespace goog.crypt.baseN {
     ...
     * @type {string}
     */
    let BASE_BINARY: string;

    /**
     * Base-8, i.e. '01234567'.
     * @type {string}
     */
    let BASE_OCTAL: string;

    /**
     * Base-10, i.e. '0123456789'.
     * @type {string}
     */
    let BASE_DECIMAL: string;

    /**
     * Base-16 using lower case, i.e. '0123456789abcdef'.
     * @type {string}
     */
    let BASE_LOWERCASE_HEXADECIMAL: string;

    /**
     * Base-16 using upper case, i.e. '0123456789ABCDEF'.
     * @type {string}
     */
    let BASE_UPPERCASE_HEXADECIMAL: string;

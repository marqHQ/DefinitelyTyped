...
declare namespace goog.fx {
    ...
    abstract class __Dragger extends goog.events.__EventTarget {
        /**
         ...
         */
        pageScroll: goog.math.Coordinate|null;
         ...
         * @private {boolean}
         */
        private dragging_: any /*missing*/;

        /**
         * Whether mousedown should be default prevented.
         * @private {boolean}
         **/
        private preventMouseDown_: any /*missing*/;
         ...
         * @private {number}
         */
        private hysteresisDistanceSquared_: any /*missing*/;
         ...
         * @private {boolean}
         */
        private ieDragStartCancellingOn_: any /*missing*/;
         ...
         * @private {boolean}
         */
        private useRightPositioningForRtl_: any /*missing*/;

        /** @private {boolean} Avoids setCapture() calls to fix click handlers. */
        private useSetCapture_: any /*missing*/;
         ...
         * @template T
         */
        getHandler(): goog.events.EventHandler<this>;
         ...
         */
        setLimits(limits: goog.math.Rect|null): void;
         ...
         * @private
         */
        private isRightToLeft_(): boolean;
         ...
         * @private
         */
        private fireDragStart_(e: goog.events.BrowserEvent): boolean;
         ...
         * @private
         */
        private cleanUpAfterDragging_(): void;
         ...
         * @private
         */
        private handleMove_(e: goog.events.BrowserEvent): void;
         ...
         * @private
         */
        private calculatePosition_(dx: number, dy: number): goog.math.Coordinate;
         ...
         * @private
         */
        private onScroll_(e: goog.events.BrowserEvent): void;
         ...
         * @protected
         */
        protected doDrag(e: goog.events.BrowserEvent, x: number, y: number, dragFromScroll: boolean): void;
    ...
    abstract class __DragEvent extends goog.events.__Event {
        /**
...
declare namespace goog.fx.Dragger {
    /**

...
declare namespace goog.events {
    ...
    abstract class __BrowserEvent extends goog.events.__Event {
        /**
         ...
         */
        getBrowserEvent(): goog.GlobalEvent;
    }
}
...
declare namespace goog.events.BrowserEvent {
     ...
     */
    let IEButtonMap: number[];

    /**
     * Static data for mapping mouse buttons.
     * @const {!Array<number>}
     */
    const IE_BUTTON_MAP: any /*missing*/;

    /**
     * Static data for mapping MSPointerEvent types to PointerEvent types.
     * @const {!Object<number, goog.events.BrowserEvent.PointerType>}
     */
    const IE_POINTER_TYPE_MAP: any /*missing*/;
}

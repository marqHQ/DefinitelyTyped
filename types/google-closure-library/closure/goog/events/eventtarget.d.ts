...
declare namespace goog.events {
    ...
    abstract class __EventTarget extends goog.__Disposable implements goog.events.Listenable {
        /**
         */
        constructor();
         ...
         */
        private eventTargetListeners_: any /*missing*/;
         ...
         * @private {!Object}
         */
        private actualEventTarget_: any /*missing*/;
         ...
         */
        private parentEventTarget_: any /*missing*/;
         ...
         */
        setParentEventTarget(parent: goog.events.EventTarget|null): void;
         ...
         */
        addEventListener(
            type: string|goog.events.EventId<any>,
            handler: ((_0: any) => any)|({handleEvent: (_0: any) => any})|null,
            opt_capture?: boolean,
         ...
         * @private
         */
        private assertInitialized_(): void;
         ...
         * @param {function(this:SCOPE, EVENTOBJ):(boolean|void)} listener Callback
         *     method.
         ...
         * @param {function(this:SCOPE, EVENTOBJ):(boolean|void)} listener The

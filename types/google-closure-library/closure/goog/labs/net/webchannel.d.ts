...
declare namespace goog.net.WebChannel {
    interface FailureRecovery {
         ...
         */
        setFailure(failure: goog.net.WebChannel.FailureRecovery.FailureCondition, operation: Function):
    ...
    interface RuntimeProperties {
         ...
         */
        notifyNonAckedMessageCount(count: number, callback: () => void): void;
         ...
         */
        onCommit(callback: (_0: Object) => void): void;
     ...
     */
    interface Options {
        messageHeaders: {[key: string]: string}|undefined;
        initMessageHeaders: {[key: string]: string}|undefined;
        messageContentType: string|undefined;
        messageUrlParams: {[key: string]: string}|undefined;
        clientProtocolHeaderRequired: boolean|undefined;
        concurrentRequestLimit: number|undefined;
        supportsCrossDomainXhr: boolean|undefined;
        testUrl: string|undefined;
        ...
        disableRedact: boolean|undefined;
        clientProfile: string|undefined;
        internalChannelParams: {[key: string]: boolean|number}|undefined;
        xmlHttpFactory: goog.net.XmlHttpFactory|undefined;
        requestRefreshThresholds: {[key: string]: number}|undefined;
    }
     ...
     */
    type MessageData = ArrayBuffer|Blob|{[key: string]: Object | string}|any[]|string;
     ...
     * @type {string}
     */
    let X_CLIENT_PROTOCOL_WEB_CHANNEL: string;
     ...
     * @type {string}
     */
    let X_CLIENT_WIRE_PROTOCOL: string;
     ...
     * @type {string}
     */
    let X_HTTP_INITIAL_RESPONSE: string;
     ...
     * @type {string}
     */
    let X_WEBCHANNEL_CONTENT_TYPE: string;
     ...
     * @type {string}
     */
    let X_WEBCHANNEL_CLIENT_PROFILE: string;
}

declare namespace goog.net.WebChannel.FailureRecovery {
    /**
     * Enum to indicate the current recovery state.
     *
     * @enum {string}
     */
    enum State { INIT, FAILED, RECOVERING, CLOSED }
     ...
     * @enum {string}
     */
    enum FailureCondition { HTTP_ERROR, ABORT, TIMEOUT, EXCEPTION }
}

...
declare namespace goog.labs {
    class Promise<TYPE, RESOLVER_CONTEXT> extends __Promise<TYPE, RESOLVER_CONTEXT> {}
    /** Fake class which should be extended to avoid inheriting static properties */
    abstract class __Promise<TYPE, RESOLVER_CONTEXT> implements goog.Thenable<TYPE> {
        /**
        ...
        constructor(
            resolver: {
                (_0: {(_0: TYPE|IThenable<TYPE>|Thenable<any>): any /*missing*/}, _1: {(_0: any): any /*missing*/}):
                    void
            },

...
declare namespace goog.labs.events {
    ...
    abstract class __NonDisposableEventTarget implements goog.events.Listenable {
        /**
         */
        constructor();
        ...
        listen<SCOPE, EVENTOBJ>(
            ...
            listener: (this: SCOPE, _0: EVENTOBJ) => boolean | undefined,
...
declare namespace goog.labs.events.NonDisposableEventTarget {
}

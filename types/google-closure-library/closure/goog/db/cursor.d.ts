...
declare namespace goog.db {
    ...
    abstract class __Cursor extends goog.events.__EventTarget {
        /**
         */
        constructor();
...
declare namespace goog.db.Cursor {
    /**
     ...
     */
    function openCursor(
        source: IDBObjectStore|IDBIndex, opt_range?: goog.db.KeyRange, opt_direction?: goog.db.Cursor.Direction
    ): goog.db.Cursor;

...
declare namespace goog.structs {
    ...
    abstract class __Map<K, V> {
         ...
         * @private
         */
        private cleanupKeysArray_(): void;
         ...
         * @template T
         */
        forEach<T>(f: (this: T, _0: V, _1: K, _2: goog.structs.Map<K, V>) => void, opt_obj?: T): void;
...
declare namespace goog.structs.Map {
    /**

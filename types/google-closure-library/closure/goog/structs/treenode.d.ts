...
declare namespace goog.structs {
    ...
    abstract class __TreeNode<KEY, VALUE> extends goog.structs.__Node<KEY, VALUE> {
        /**
         * @param {KEY} key Key.
         ...
         */
        private parent_: goog.structs.TreeNode<KEY, VALUE>;

        /**
         * Child nodes or null in case of leaf node.
         * @private {Array<!goog.structs.TreeNode<KEY, VALUE>>}
         */
        private children_: goog.structs.TreeNode<KEY, VALUE>[];
        ...
        forEachChild<THIS>(
            f: (this: THIS,
                _0: goog.structs.TreeNode<KEY, VALUE>,
                _1: number,
                _2: goog.structs.TreeNode<KEY, VALUE>[]) => void,
            opt_this?: THIS
        ): void;
         ...
         * @template THIS
         */
        forEachDescendant<THIS>(f: (this: THIS, _0: goog.structs.TreeNode<KEY, VALUE>) => void, opt_this?: THIS): void;
         ...
         * @template THIS
         */
        traverse<THIS>(f: (this: THIS, _0: goog.structs.TreeNode<KEY, VALUE>) => boolean | undefined, opt_this?: THIS):
            void;
         ...
         * @protected
         */
        protected setParent(parent: goog.structs.TreeNode<KEY, VALUE>): void;
         ...
         *     detached from its parent.
         */
        replaceChild(newChild: goog.structs.TreeNode<KEY, VALUE>, oldChild: goog.structs.TreeNode<KEY, VALUE>):
...
declare namespace goog.structs.TreeNode {
    /**
     ...
     * @template KEY, VALUE
     */
    function findCommonAncestor<KEY, VALUE>(...var_args: goog.structs.TreeNode<KEY, VALUE>[]):
        goog.structs.TreeNode<KEY, VALUE>;
}

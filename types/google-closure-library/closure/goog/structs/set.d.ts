...
declare namespace goog.structs {
    ...
    abstract class __Set<T> implements goog.structs.Collection<T> {
        /**
         * @param {Array<T>|Object<?,T>=} opt_values Initial values to start with.
         */
        constructor(opt_values?: T[]|{[key: number]: T}|{[key: string]: T});
         ...
         */
        addAll(col: T[]|goog.structs.Collection<T>|{[key: number]: T}|{[key: string]: T}): void;
         ...
         */
        removeAll(col: T[]|goog.structs.Collection<T>|{[key: number]: T}|{[key: string]: T}): void;
         ...
         * @template S
         */
        intersection<S>(col: S[]|{[key: number]: S}|{[key: string]: S}): goog.structs.Set<T|S>;
         ...
         *     collection.
         */
        difference(col: T[]|goog.structs.Collection<T>|{[key: number]: T}|{[key: string]: T}): goog.structs.Set<any>;
...
declare namespace goog.structs.Set {
}

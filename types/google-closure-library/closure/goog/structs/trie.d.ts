...
declare namespace goog.structs {
    ...
    abstract class __Trie<VALUE> {
         ...
         */
        private childNodes_: {[key: string]: goog.structs.Trie<VALUE>};
         ...
         * @private
         */
        private setOrAdd_(key: string, value: VALUE, opt_add?: boolean): void;
         ...
         * @private
         */
        private getChildNode_(path: string): goog.structs.Trie<VALUE>|undefined;
         ...
         */
        getKeyAndPrefixes(key: string, opt_keyStartIndex?: number|null): {[key: string]: VALUE};
         ...
         * @private
         */
        private getValuesInternal_(allValues: VALUE[]): void;
         ...
         * @private
         */
        private getKeysInternal_(keySoFar: string, allKeys: string[]): void;

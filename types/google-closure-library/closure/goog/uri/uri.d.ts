...
declare namespace goog {
    ...
    abstract class __Uri {
         ...
         * @private {string}
         */
        private scheme_: any /*missing*/;

        /**
         * User credentials in the form "username:password".
         * @private {string}
         */
        private userInfo_: any /*missing*/;

        /**
         * Domain part, e.g. "www.google.com".
         * @private {string}
         */
        private domain_: any /*missing*/;

        /**
         * Port, e.g. 8080.
         * @private {?number}
         */
        private port_: any /*missing*/;
         ...
         * @private {string}
         */
        private fragment_: any /*missing*/;

        /**
         * Whether or not this Uri should be treated as Read Only.
         * @private {boolean}
         */
        private isReadOnly_: any /*missing*/;

        /**
         * Whether or not to ignore case when comparing query params.
         * @private {boolean}
         */
        private ignoreCase_: any /*missing*/;

        /**
         * Object representing query data.
         * @private {!goog.Uri.QueryData}
         */
        private queryData_: any /*missing*/;
         ...
         * @return {!goog.Uri} Reference to this URI object.
         */
        setQueryData(queryData: goog.Uri.QueryData|string|undefined, opt_decode?: boolean): goog.Uri;
...
declare namespace goog.Uri {
    ...
    abstract class __QueryData {
         ...
         *     name in #get.
         */
        constructor(opt_query?: string|null, opt_uri?: goog.Uri, opt_ignoreCase?: boolean);
         ...
         */
        private keyMap_: any /*missing*/;

        /**
         * The number of params, or null if it requires computing.
         * @private {?number}
         */
        private count_: any /*missing*/;

        /**
         * Encoded query string, or null if it requires computing from the key map.
         * @private {?string}
         */
        private encodedQuery_: any /*missing*/;
         ...
         * @template SCOPE
         */
        forEach<SCOPE>(f: (this: SCOPE, _0: any, _1: string, _2: goog.Uri.QueryData) => void, opt_scope?: SCOPE): void;
         ...
         */
        private getKeyName_(arg: any): string;
         ...
         * types of parameters.
         */
        extend(...var_args: (goog.Uri.QueryData|goog.structs.Map<any, any>|Object|null)[]): void;
    }
     ...
     * @type {boolean}
     */
    let preserveParameterTypesCompatibilityFlag: boolean;

    /**
     * Parameter name added to stop caching.
     * @type {string}
     */
    let RANDOM_PARAM: string;
     ...
     */
    function create(
        opt_scheme?: string|null,
        opt_userInfo?: string|null,
        opt_domain?: string|null,
        opt_port?: number|null,
...
declare namespace goog.Uri.QueryData {
    /**
     ...
     */
    function createFromMap(map: goog.structs.Map<string, any>|Object, opt_uri?: goog.Uri, opt_ignoreCase?: boolean):
        goog.Uri.QueryData;
     ...
     * @return {!goog.Uri.QueryData} The populated query data instance.
     */
    function createFromKeysValues(keys: string[], values: any[], opt_uri?: goog.Uri, opt_ignoreCase?: boolean):
        goog.Uri.QueryData;
}

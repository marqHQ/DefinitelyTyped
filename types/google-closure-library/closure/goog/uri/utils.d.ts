...
declare namespace goog.uri.utils {
     ...
     */
    function parseQueryData(encodedQuery: string, callback: (_0: string, _1: string) => void): void;
     ...
     */
    function buildQueryData(keysAndValues: IArrayLike<string|goog.uri.utils.QueryValue>, opt_startIndex?: number):
        string;
     ...
     * @return {string} The encoded query string, in the form 'a=1&b=2'.
     */
    function buildQueryDataFromMap(map: {[key: string]: goog.uri.utils.QueryValue}): string;
     ...
     */
    function appendParamsFromMap(uri: string, map: {[key: string]: goog.uri.utils.QueryValue}): string;
     ...
     *     the params.
     */
    function setParamsFromMap(uri: string, params: {[key: string]: goog.uri.utils.QueryValue}): string;

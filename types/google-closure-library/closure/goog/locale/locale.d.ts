...
declare namespace goog.locale {
     ...
     */
    function getLocalizedRegionNameFromRegionCode(regionCode: string, opt_localeSymbols?: Object|null): string;
     ...
     */
    function getResource(resourceName: string, opt_locale?: string): Object|undefined;
     ...
     */
    function getResourceWithFallback(resourceName: string, opt_locale?: string): Object|undefined;
}

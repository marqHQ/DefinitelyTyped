...
declare namespace goog.html.testing {
     ...
     */
    function newSafeHtmlForTest(html: string, opt_dir?: goog.i18n.bidi.Dir|null): goog.html.SafeHtml;
     ...
     * @return {!goog.testing.mockmatchers.ArgumentMatcher}
     */
    function matchTrustedResourceUrl(expected: string|
                                     goog.html.TrustedResourceUrl): goog.testing.mockmatchers.ArgumentMatcher;

...
declare namespace goog.html.uncheckedconversions {
    ...
    function safeHtmlFromStringKnownToSatisfyTypeContract(
        justification: goog.string.Const, html: string, opt_dir?: goog.i18n.bidi.Dir|null
    ): goog.html.SafeHtml;
     ...
     *     SafeScript object.
     */
    function safeScriptFromStringKnownToSatisfyTypeContract(justification: goog.string.Const, script: string):
     ...
     *     SafeStyle object.
     */
    function safeStyleFromStringKnownToSatisfyTypeContract(justification: goog.string.Const, style: string):
        goog.html.SafeStyle;
     ...
     */
    function safeStyleSheetFromStringKnownToSatisfyTypeContract(justification: goog.string.Const, styleSheet: string):
     ...
     *     object.
     */
    function safeUrlFromStringKnownToSatisfyTypeContract(justification: goog.string.Const, url: string):
        goog.html.SafeUrl;
     ...
     */
    function trustedResourceUrlFromStringKnownToSatisfyTypeContract(justification: goog.string.Const, url: string):

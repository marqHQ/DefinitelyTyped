...
declare namespace goog.tweak {
     ...
     */
    type ConfigParams = {
        label: string|undefined; validValues: string[] | number[] | undefined; paramName: string | undefined;
        restartRequired: boolean | undefined;
        callback: Function | undefined;
        token: string | undefined
    }|Object;
    ...
    function registerBoolean(
        id: string, description: string, opt_defaultValue?: boolean, opt_configParams?: goog.tweak.ConfigParams
    ): void;
    ...
    function registerString(
        id: string, description: string, opt_defaultValue?: string, opt_configParams?: goog.tweak.ConfigParams
    ): void;
    ...
    function registerNumber(
        id: string, description: string, opt_defaultValue?: number, opt_configParams?: goog.tweak.ConfigParams
    ): void;
